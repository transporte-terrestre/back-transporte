...
export const conductorDocumentos = pgTable("conductor_documentos", {
  ...
  conductorId: integer("conductor_id").notNull().references(() => conductores.id, { onDelete: "cascade" }),
...
export type ConductorDocumentoTipo =
  (typeof conductorDocumentosTipo.enumValues)[number];
