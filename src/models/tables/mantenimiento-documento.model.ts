...
export type MantenimientoDocumentoTipo =
  (typeof mantenimientoDocumentosTipo.enumValues)[number];
export type MantenimientoDocumento =
  typeof mantenimientoDocumentos.$inferSelect;
export type MantenimientoDocumentoDTO =
  typeof mantenimientoDocumentos.$inferInsert;
