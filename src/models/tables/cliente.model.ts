import { pgTable, serial, varchar, timestamp, text, pgEnum, index, uniqueIndex, decimal } from 'drizzle-orm/pg-core';
...
export const clientes = pgTable(
  ...
  (t) => [
    // Índices de búsqueda
    index('clientes_nombre_completo_idx').using('gin', t.nombreCompleto.op('gin_trgm_ops')),
