...
export class NotificacionesService {
  ...
  private formatearTipoDocumento(tipo: string): string {
    const formatMap: Record<string, string> = {
      ...
      autoriza_ssgg: 'Autorización SSGG',
      curso_seguridad_portuaria: 'Curso Seg. Portuaria',
      curso_mercancias_peligrosas: 'Curso Mercancías Peligrosas',
      curso_basico_pbip: 'Curso Básico PBIP',
      examen_medico_temporal: 'Examen Médico Temporal',
      induccion_visita: 'Inducción Visita',
      em_visita: 'EM Visita',
      pase_conduc: 'Pase Conducción',
      foto_funcionario: 'Foto Funcionario',
      ...
      certificado_extintores_hidrostatica: 'Cert. Prueba Hidrostática (Extintores)',
      certificado_extintores_operatividad: 'Cert. Operatividad (Extintores)',
      certificado_rops: 'Certificado ROPS',
      certificado_radio_frecuencia: 'Cert. Radio Frecuencia',
      certificacion_frenos: 'Certificación de Frenos',
