...
import { InspeccionDocumentosDto } from '../types/inspeccion-documentos.dto';
...
const items = [
  ...
  defineItem('El SOAT se encuentra en la unidad y se encuentra vigente', 1, { camposExtras: extraFields }),
  defineItem('La Tarjeta de Propiedad se encuentra en el vehículo', 2, { camposExtras: extraFields }),
  defineItem('La Tarjeta de Circulación se encuentra en el vehículo y está vigente', 3, { camposExtras: extraFields }),
  defineItem('La Póliza se encuentra en el vehículo y se encuentra vigente', 4, { camposExtras: extraFields }),
  defineItem('El CTIV se encuentra en el vehículo y se encuentra vigente', 5, { camposExtras: extraFields }),
  defineItem('Se cuenta con las Hojas MSDS de los productos químicos', 6, { camposExtras: extraFields }),
  defineItem('Se cuenta con el Manual de Operación del Vehículo', 7, { camposExtras: extraFields }),
  defineItem('Otro (Vehículo)', 8, { camposExtras: extraFields }),

  // DOCUMENTOS DEL CONDUCTOR
  defineItem('El Conductor cuenta con Licencia del MTC vigente', 9, { camposExtras: extraFields }),
  defineItem('El Conductor cuenta con su Licencia Interna de Manejo vigente', 10, { camposExtras: extraFields }),
  defineItem('El Conductor cuenta con el Check List Diario firmado por el Supervisor de Operaciones', 11, { camposExtras: extraFields }),
  ...
  defineItem('El Conductor cuenta con el PETS correspondiente de su Actividad/Tarea', 13, { camposExtras: extraFields }),
  defineItem('Se cuenta con las Hojas MSDS de los productos químicos (Conductor)', 14, { camposExtras: extraFields }),
  defineItem('Se cuenta con el mapa de riesgos - Rutas', 15, { camposExtras: extraFields }),
  defineItem('Otro (Conductor)', 16, { camposExtras: extraFields }),
];
