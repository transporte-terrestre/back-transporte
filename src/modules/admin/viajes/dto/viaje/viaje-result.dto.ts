...
import { EncargadoResultDto } from '../../../clientes/dto/encargado/encargado-result.dto';
...
export class ViajeVehiculoDetalleDto extends OmitType(VehiculoResultDto, ['documentos', 'proveedores']) {
