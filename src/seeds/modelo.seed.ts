...
const modelosPorMarca: Record<string, string[]> = {
  Toyota: ['Corolla', 'Yaris', 'Camry', 'RAV4', 'Hilux', 'Land Cruiser', 'Hiace', 'Coaster'],
  Hyundai: ['Elantra', 'Accent', 'Sonata', 'Tucson', 'Santa Fe', 'County', 'H-1'],
  Nissan: ['Sentra', 'Versa', 'Altima', 'Frontier', 'Navara', 'X-Trail', 'Urvan'],
  Honda: ['Civic', 'City', 'Accord', 'CR-V', 'HR-V', 'Pilot', 'Odyssey'],
  Mazda: ['Mazda2', 'Mazda3', 'Mazda6', 'CX-3', 'CX-5', 'CX-9', 'BT-50'],
  Chevrolet: ['Cruze', 'Sail', 'Malibu', 'Tracker', 'Equinox', 'Silverado', 'N300'],
  Kia: ['Forte', 'Rio', 'Optima', 'Sportage', 'Sorento', 'Carnival', 'Bongo'],
  Volkswagen: ['Jetta', 'Polo', 'Passat', 'Tiguan', 'T-Cross', 'Amarok', 'Crafter'],
  Ford: ['Focus', 'Fiesta', 'Fusion', 'Escape', 'Explorer', 'F-150', 'Transit'],
  Suzuki: ['Ciaz', 'Swift', 'Baleno', 'Vitara', 'Jimny', 'Ertiga', 'Carry'],
  Mitsubishi: ['Lancer', 'Mirage', 'Outlander', 'ASX', 'L200', 'Montero', 'Canter'],
  Subaru: ['Impreza', 'Legacy', 'Outback', 'Forester', 'XV', 'WRX'],
  'Mercedes-Benz': ['Clase A', 'Clase C', 'Clase E', 'Clase S', 'GLC', 'Sprinter', 'Actros'],
  ...
  Renault: ['Logan', 'Sandero', 'Megane', 'Duster', 'Koleos', 'Kangoo', 'Master'],
...
export async function seedModelos(marcasData: Marca[]): Promise<Modelo[]> {
  ...
  const modelosData = await database.insert(modelos).values(modelosValues).returning();
