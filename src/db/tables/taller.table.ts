import { pgTable, serial, varchar, timestamp, pgEnum, index, uniqueIndex } from 'drizzle-orm/pg-core';
...
export const talleres = pgTable(
  ...
  (t) => [
    // Índices de búsqueda
    index('talleres_razon_social_idx').using('gin', t.razonSocial.op('gin_trgm_ops')),
    index('talleres_nombre_comercial_idx').using('gin', t.nombreComercial.op('gin_trgm_ops')),
